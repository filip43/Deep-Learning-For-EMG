...
X_train_orig, Y_train_orig, X_test_orig, Y_test_orig = load_dataset("PreProccessed/s1NoZero/", NoZero = True)
...
parameters = model(X_train, Y_train, X_test, Y_test, learning_rate = 0.001,
          num_epochs = 700, minibatch_size = 256, print_cost = True, layer1Size=64, layer2Size=64, keep_probability = 0.65)
end =time.time()
